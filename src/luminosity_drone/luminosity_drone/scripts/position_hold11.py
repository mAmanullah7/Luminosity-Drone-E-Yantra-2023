...
class swift():
	...
	def altitude_set_pid(self,alt):
		self.Kp[2] = alt.Kp * 60.0             # This is just for an example. You can change the ratio/fraction value accordingly
	...
	def roll_set_pid(self,roll):
		self.Kp[0] = roll.Kp * 60.0                   # This is just for an example. You can change the ratio/fraction value accordingly
		self.Ki[0] = roll.Ki * 0.01
		self.Kd[0] = roll.Kd * 0.01

	
	def pitch_set_pid(self,pitch):
		self.Kp[1] = pitch.Kp * 60.0          # This is just for an example. You can change the ratio/fraction value accordingly
	...
	#------------------------------------------------------------------------------------------------------------
		...
		self.error[2]=int(self.setpoint[2] - self.drone_position[2] )  
